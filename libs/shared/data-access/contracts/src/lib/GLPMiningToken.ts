export default [
  {
    inputs: [
      { internalType: 'address', name: '_AAVE_rAAVE', type: 'address' },
      { internalType: 'address', name: '_rAAVE', type: 'address' },
    ],
  ...
  },
  {
    ...
    name: 'calcSharesFromTokenAmount',
    outputs: [{ internalType: 'uint256', name: '_shares', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    name: 'calcTokenAmountFromShares',
  ...
  },
  {
    ...
    name: 'rewardInfo',
    outputs: [
      { internalType: 'uint256', name: '_lockedReward', type: 'uint256' },
      { internalType: 'uint256', name: '_unlockedReward', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_rewardRatePerWeek', type: 'uint256' },
    ],
    name: 'setRewardRatePerWeek',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
